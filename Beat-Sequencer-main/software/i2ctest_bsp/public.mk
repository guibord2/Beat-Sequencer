...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2290
SOPC_SYSID_FLAG += --sidp=0x2290
ELF_PATCH_FLAG  += --sidp 0x2290

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682622620
SOPC_SYSID_FLAG += --timestamp=1682622620
ELF_PATCH_FLAG  += --timestamp 1682622620
