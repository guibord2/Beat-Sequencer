...
module lab62_soc_mm_interconnect_0 (
		...
		output wire [1:0]  Xdisp_s1_address,                               //                                 Xdisp_s1.address
		output wire        Xdisp_s1_write,                                 //                                         .write
		input  wire [31:0] Xdisp_s1_readdata,                              //                                         .readdata
		output wire [31:0] Xdisp_s1_writedata,                             //                                         .writedata
		output wire        Xdisp_s1_chipselect,                            //                                         .chipselect
		output wire [1:0]  Ydisp_s1_address,                               //                                 Ydisp_s1.address
		output wire        Ydisp_s1_write,                                 //                                         .write
		input  wire [31:0] Ydisp_s1_readdata,                              //                                         .readdata
		output wire [31:0] Ydisp_s1_writedata,                             //                                         .writedata
		output wire        Ydisp_s1_chipselect                             //                                         .chipselect
	);
	...
	wire   [17:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> button_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> timer_s1_agent:cp_data
	...
	wire   [31:0] xdisp_s1_agent_m0_readdata;                                                         // Xdisp_s1_translator:uav_readdata -> Xdisp_s1_agent:m0_readdata
	wire          xdisp_s1_agent_m0_waitrequest;                                                      // Xdisp_s1_translator:uav_waitrequest -> Xdisp_s1_agent:m0_waitrequest
	wire          xdisp_s1_agent_m0_debugaccess;                                                      // Xdisp_s1_agent:m0_debugaccess -> Xdisp_s1_translator:uav_debugaccess
	wire   [27:0] xdisp_s1_agent_m0_address;                                                          // Xdisp_s1_agent:m0_address -> Xdisp_s1_translator:uav_address
	wire    [3:0] xdisp_s1_agent_m0_byteenable;                                                       // Xdisp_s1_agent:m0_byteenable -> Xdisp_s1_translator:uav_byteenable
	wire          xdisp_s1_agent_m0_read;                                                             // Xdisp_s1_agent:m0_read -> Xdisp_s1_translator:uav_read
	wire          xdisp_s1_agent_m0_readdatavalid;                                                    // Xdisp_s1_translator:uav_readdatavalid -> Xdisp_s1_agent:m0_readdatavalid
	wire          xdisp_s1_agent_m0_lock;                                                             // Xdisp_s1_agent:m0_lock -> Xdisp_s1_translator:uav_lock
	wire   [31:0] xdisp_s1_agent_m0_writedata;                                                        // Xdisp_s1_agent:m0_writedata -> Xdisp_s1_translator:uav_writedata
	wire          xdisp_s1_agent_m0_write;                                                            // Xdisp_s1_agent:m0_write -> Xdisp_s1_translator:uav_write
	wire    [2:0] xdisp_s1_agent_m0_burstcount;                                                       // Xdisp_s1_agent:m0_burstcount -> Xdisp_s1_translator:uav_burstcount
	wire          xdisp_s1_agent_rf_source_valid;                                                     // Xdisp_s1_agent:rf_source_valid -> Xdisp_s1_agent_rsp_fifo:in_valid
	wire  [108:0] xdisp_s1_agent_rf_source_data;                                                      // Xdisp_s1_agent:rf_source_data -> Xdisp_s1_agent_rsp_fifo:in_data
	wire          xdisp_s1_agent_rf_source_ready;                                                     // Xdisp_s1_agent_rsp_fifo:in_ready -> Xdisp_s1_agent:rf_source_ready
	wire          xdisp_s1_agent_rf_source_startofpacket;                                             // Xdisp_s1_agent:rf_source_startofpacket -> Xdisp_s1_agent_rsp_fifo:in_startofpacket
	wire          xdisp_s1_agent_rf_source_endofpacket;                                               // Xdisp_s1_agent:rf_source_endofpacket -> Xdisp_s1_agent_rsp_fifo:in_endofpacket
	wire          xdisp_s1_agent_rsp_fifo_out_valid;                                                  // Xdisp_s1_agent_rsp_fifo:out_valid -> Xdisp_s1_agent:rf_sink_valid
	wire  [108:0] xdisp_s1_agent_rsp_fifo_out_data;                                                   // Xdisp_s1_agent_rsp_fifo:out_data -> Xdisp_s1_agent:rf_sink_data
	wire          xdisp_s1_agent_rsp_fifo_out_ready;                                                  // Xdisp_s1_agent:rf_sink_ready -> Xdisp_s1_agent_rsp_fifo:out_ready
	wire          xdisp_s1_agent_rsp_fifo_out_startofpacket;                                          // Xdisp_s1_agent_rsp_fifo:out_startofpacket -> Xdisp_s1_agent:rf_sink_startofpacket
	wire          xdisp_s1_agent_rsp_fifo_out_endofpacket;                                            // Xdisp_s1_agent_rsp_fifo:out_endofpacket -> Xdisp_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> Xdisp_s1_agent:cp_valid
	wire  [107:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> Xdisp_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // Xdisp_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [17:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> Xdisp_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> Xdisp_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> Xdisp_s1_agent:cp_endofpacket
	wire   [31:0] ydisp_s1_agent_m0_readdata;                                                         // Ydisp_s1_translator:uav_readdata -> Ydisp_s1_agent:m0_readdata
	wire          ydisp_s1_agent_m0_waitrequest;                                                      // Ydisp_s1_translator:uav_waitrequest -> Ydisp_s1_agent:m0_waitrequest
	wire          ydisp_s1_agent_m0_debugaccess;                                                      // Ydisp_s1_agent:m0_debugaccess -> Ydisp_s1_translator:uav_debugaccess
	wire   [27:0] ydisp_s1_agent_m0_address;                                                          // Ydisp_s1_agent:m0_address -> Ydisp_s1_translator:uav_address
	wire    [3:0] ydisp_s1_agent_m0_byteenable;                                                       // Ydisp_s1_agent:m0_byteenable -> Ydisp_s1_translator:uav_byteenable
	wire          ydisp_s1_agent_m0_read;                                                             // Ydisp_s1_agent:m0_read -> Ydisp_s1_translator:uav_read
	wire          ydisp_s1_agent_m0_readdatavalid;                                                    // Ydisp_s1_translator:uav_readdatavalid -> Ydisp_s1_agent:m0_readdatavalid
	wire          ydisp_s1_agent_m0_lock;                                                             // Ydisp_s1_agent:m0_lock -> Ydisp_s1_translator:uav_lock
	wire   [31:0] ydisp_s1_agent_m0_writedata;                                                        // Ydisp_s1_agent:m0_writedata -> Ydisp_s1_translator:uav_writedata
	wire          ydisp_s1_agent_m0_write;                                                            // Ydisp_s1_agent:m0_write -> Ydisp_s1_translator:uav_write
	wire    [2:0] ydisp_s1_agent_m0_burstcount;                                                       // Ydisp_s1_agent:m0_burstcount -> Ydisp_s1_translator:uav_burstcount
	wire          ydisp_s1_agent_rf_source_valid;                                                     // Ydisp_s1_agent:rf_source_valid -> Ydisp_s1_agent_rsp_fifo:in_valid
	wire  [108:0] ydisp_s1_agent_rf_source_data;                                                      // Ydisp_s1_agent:rf_source_data -> Ydisp_s1_agent_rsp_fifo:in_data
	wire          ydisp_s1_agent_rf_source_ready;                                                     // Ydisp_s1_agent_rsp_fifo:in_ready -> Ydisp_s1_agent:rf_source_ready
	wire          ydisp_s1_agent_rf_source_startofpacket;                                             // Ydisp_s1_agent:rf_source_startofpacket -> Ydisp_s1_agent_rsp_fifo:in_startofpacket
	wire          ydisp_s1_agent_rf_source_endofpacket;                                               // Ydisp_s1_agent:rf_source_endofpacket -> Ydisp_s1_agent_rsp_fifo:in_endofpacket
	wire          ydisp_s1_agent_rsp_fifo_out_valid;                                                  // Ydisp_s1_agent_rsp_fifo:out_valid -> Ydisp_s1_agent:rf_sink_valid
	wire  [108:0] ydisp_s1_agent_rsp_fifo_out_data;                                                   // Ydisp_s1_agent_rsp_fifo:out_data -> Ydisp_s1_agent:rf_sink_data
	wire          ydisp_s1_agent_rsp_fifo_out_ready;                                                  // Ydisp_s1_agent:rf_sink_ready -> Ydisp_s1_agent_rsp_fifo:out_ready
	wire          ydisp_s1_agent_rsp_fifo_out_startofpacket;                                          // Ydisp_s1_agent_rsp_fifo:out_startofpacket -> Ydisp_s1_agent:rf_sink_startofpacket
	wire          ydisp_s1_agent_rsp_fifo_out_endofpacket;                                            // Ydisp_s1_agent_rsp_fifo:out_endofpacket -> Ydisp_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_016_src_valid;                                                              // cmd_mux_016:src_valid -> Ydisp_s1_agent:cp_valid
	wire  [107:0] cmd_mux_016_src_data;                                                               // cmd_mux_016:src_data -> Ydisp_s1_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                              // Ydisp_s1_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [17:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> Ydisp_s1_agent:cp_channel
	wire          cmd_mux_016_src_startofpacket;                                                      // cmd_mux_016:src_startofpacket -> Ydisp_s1_agent:cp_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                        // cmd_mux_016:src_endofpacket -> Ydisp_s1_agent:cp_endofpacket
	...
	wire  [107:0] timer_s1_agent_rp_data;                                                             // timer_s1_agent:rp_data -> router_016:sink_data
	...
	wire          xdisp_s1_agent_rp_valid;                                                            // Xdisp_s1_agent:rp_valid -> router_017:sink_valid
	wire  [107:0] xdisp_s1_agent_rp_data;                                                             // Xdisp_s1_agent:rp_data -> router_017:sink_data
	wire          xdisp_s1_agent_rp_ready;                                                            // router_017:sink_ready -> Xdisp_s1_agent:rp_ready
	wire          xdisp_s1_agent_rp_startofpacket;                                                    // Xdisp_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          xdisp_s1_agent_rp_endofpacket;                                                      // Xdisp_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          ydisp_s1_agent_rp_valid;                                                            // Ydisp_s1_agent:rp_valid -> router_018:sink_valid
	wire  [107:0] ydisp_s1_agent_rp_data;                                                             // Ydisp_s1_agent:rp_data -> router_018:sink_data
	wire          ydisp_s1_agent_rp_ready;                                                            // router_018:sink_ready -> Ydisp_s1_agent:rp_ready
	wire          ydisp_s1_agent_rp_startofpacket;                                                    // Ydisp_s1_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          ydisp_s1_agent_rp_endofpacket;                                                      // Ydisp_s1_agent:rp_endofpacket -> router_018:sink_endofpacket
	...
	wire          xdisp_s1_agent_rdata_fifo_src_valid;                                                // Xdisp_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] xdisp_s1_agent_rdata_fifo_src_data;                                                 // Xdisp_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          xdisp_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_015:in_0_ready -> Xdisp_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> Xdisp_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> Xdisp_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // Xdisp_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> Xdisp_s1_agent:rdata_fifo_sink_error
	wire          ydisp_s1_agent_rdata_fifo_src_valid;                                                // Ydisp_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [33:0] ydisp_s1_agent_rdata_fifo_src_data;                                                 // Ydisp_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          ydisp_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_016:in_0_ready -> Ydisp_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                                  // avalon_st_adapter_016:out_0_valid -> Ydisp_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_016_out_0_data;                                                   // avalon_st_adapter_016:out_0_data -> Ydisp_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                                  // Ydisp_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                                  // avalon_st_adapter_016:out_0_error -> Ydisp_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (xdisp_s1_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (xdisp_s1_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (xdisp_s1_agent_m0_read),                        //                         .read
		.uav_write              (xdisp_s1_agent_m0_write),                       //                         .write
		.uav_waitrequest        (xdisp_s1_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (xdisp_s1_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (xdisp_s1_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (xdisp_s1_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (xdisp_s1_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (xdisp_s1_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (xdisp_s1_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (Xdisp_s1_address),                              //      avalon_anti_slave_0.address
		.av_write               (Xdisp_s1_write),                                //                         .write
		.av_readdata            (Xdisp_s1_readdata),                             //                         .readdata
		.av_writedata           (Xdisp_s1_writedata),                            //                         .writedata
		.av_chipselect          (Xdisp_s1_chipselect),                           //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ydisp_s1_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (ydisp_s1_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (ydisp_s1_agent_m0_read),                        //                         .read
		.uav_write              (ydisp_s1_agent_m0_write),                       //                         .write
		.uav_waitrequest        (ydisp_s1_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (ydisp_s1_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (ydisp_s1_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (ydisp_s1_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (ydisp_s1_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (ydisp_s1_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (ydisp_s1_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (Ydisp_s1_address),                              //      avalon_anti_slave_0.address
		.av_write               (Ydisp_s1_write),                                //                         .write
		.av_readdata            (Ydisp_s1_readdata),                             //                         .readdata
		.av_writedata           (Ydisp_s1_writedata),                            //                         .writedata
		.av_chipselect          (Ydisp_s1_chipselect),                           //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (xdisp_s1_agent_m0_address),                     //              m0.address
		.m0_burstcount           (xdisp_s1_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (xdisp_s1_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (xdisp_s1_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (xdisp_s1_agent_m0_lock),                        //                .lock
		.m0_readdata             (xdisp_s1_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (xdisp_s1_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (xdisp_s1_agent_m0_read),                        //                .read
		.m0_waitrequest          (xdisp_s1_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (xdisp_s1_agent_m0_writedata),                   //                .writedata
		.m0_write                (xdisp_s1_agent_m0_write),                       //                .write
		.rp_endofpacket          (xdisp_s1_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (xdisp_s1_agent_rp_ready),                       //                .ready
		.rp_valid                (xdisp_s1_agent_rp_valid),                       //                .valid
		.rp_data                 (xdisp_s1_agent_rp_data),                        //                .data
		.rp_startofpacket        (xdisp_s1_agent_rp_startofpacket),               //                .startofpacket
		...
		.rf_sink_ready           (xdisp_s1_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (xdisp_s1_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (xdisp_s1_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (xdisp_s1_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (xdisp_s1_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (xdisp_s1_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (xdisp_s1_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (xdisp_s1_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (xdisp_s1_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (xdisp_s1_agent_rf_source_data),                 //                .data
		...
		.rdata_fifo_src_ready    (xdisp_s1_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (xdisp_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (xdisp_s1_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) xdisp_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (xdisp_s1_agent_rf_source_data),                 //        in.data
		.in_valid          (xdisp_s1_agent_rf_source_valid),                //          .valid
		.in_ready          (xdisp_s1_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (xdisp_s1_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (xdisp_s1_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (xdisp_s1_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (xdisp_s1_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (xdisp_s1_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (xdisp_s1_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (xdisp_s1_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (ydisp_s1_agent_m0_address),                     //              m0.address
		.m0_burstcount           (ydisp_s1_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (ydisp_s1_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (ydisp_s1_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (ydisp_s1_agent_m0_lock),                        //                .lock
		.m0_readdata             (ydisp_s1_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (ydisp_s1_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (ydisp_s1_agent_m0_read),                        //                .read
		.m0_waitrequest          (ydisp_s1_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (ydisp_s1_agent_m0_writedata),                   //                .writedata
		.m0_write                (ydisp_s1_agent_m0_write),                       //                .write
		.rp_endofpacket          (ydisp_s1_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (ydisp_s1_agent_rp_ready),                       //                .ready
		.rp_valid                (ydisp_s1_agent_rp_valid),                       //                .valid
		.rp_data                 (ydisp_s1_agent_rp_data),                        //                .data
		.rp_startofpacket        (ydisp_s1_agent_rp_startofpacket),               //                .startofpacket
		...
		.rf_sink_ready           (ydisp_s1_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (ydisp_s1_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (ydisp_s1_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (ydisp_s1_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (ydisp_s1_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (ydisp_s1_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (ydisp_s1_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (ydisp_s1_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (ydisp_s1_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (ydisp_s1_agent_rf_source_data),                 //                .data
		...
		.rdata_fifo_src_ready    (ydisp_s1_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ydisp_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (ydisp_s1_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ydisp_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (ydisp_s1_agent_rf_source_data),                 //        in.data
		.in_valid          (ydisp_s1_agent_rf_source_valid),                //          .valid
		.in_ready          (ydisp_s1_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (ydisp_s1_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (ydisp_s1_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (ydisp_s1_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (ydisp_s1_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (ydisp_s1_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (ydisp_s1_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (ydisp_s1_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	lab62_soc_mm_interconnect_0_router_002 router_017 (
		.sink_ready         (xdisp_s1_agent_rp_ready),                       //      sink.ready
		.sink_valid         (xdisp_s1_agent_rp_valid),                       //          .valid
		.sink_data          (xdisp_s1_agent_rp_data),                        //          .data
		.sink_startofpacket (xdisp_s1_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (xdisp_s1_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_router_002 router_018 (
		.sink_ready         (ydisp_s1_agent_rp_ready),                       //      sink.ready
		.sink_valid         (ydisp_s1_agent_rp_valid),                       //          .valid
		.sink_data          (ydisp_s1_agent_rp_data),                        //          .data
		.sink_startofpacket (ydisp_s1_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (ydisp_s1_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (xdisp_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (xdisp_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (xdisp_s1_agent_rdata_fifo_src_ready),           //         .ready
	...
	lab62_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ydisp_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (ydisp_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (ydisp_s1_agent_rdata_fifo_src_ready),           //         .ready
